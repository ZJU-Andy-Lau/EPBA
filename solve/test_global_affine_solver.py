...
if __name__ == "__main__":
    img_paths = os.listdir('./datasets/wv_error_5')
    ...
    pair_results = {
        {
            ...
            1:torch.tensor([
                ...
                [3.81e-5,1.0001,-4.5636]
            ],device='cuda'),
        },
        {
            0:torch.tensor([
                [1.0,8.3122e-5,6.46e-1],
                [5.8844e-5,1.0001,7.3401]
            ],device='cuda'),
            2:torch.tensor([
                [0.99986,-1.7898e-4,9.8777e-1],
                [4.7758e-6,9.9991e-1,-7.7021]
            ],device='cuda'),
        },{
            1:torch.tensor([
                [1.0001,-3.5163e-4,-3.9321],
                [-9.1712e-5,1.0001,5.5312]
            ],device='cuda'),
            2:torch.tensor([
                [1.0001,-2.9945e-5,4.2635],
